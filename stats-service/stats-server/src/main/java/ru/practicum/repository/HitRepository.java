...
public interface HitRepository extends JpaRepository<Hit, Long> {
    ...
    List<StatsResponseDto> findUniqueHits(LocalDateTime start, LocalDateTime end, List<String> uris);
    ...
    List<StatsResponseDto> findNonUniqueHits(LocalDateTime start, LocalDateTime end, List<String> uris);
}